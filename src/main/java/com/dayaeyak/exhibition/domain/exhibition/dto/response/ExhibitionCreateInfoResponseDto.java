...
@Builder
public record ExhibitionCreateInfoResponseDto(
        Long exhibitionId,
    ...
    public static ExhibitionCreateInfoResponseDto from(Exhibition exhibition) {
        return ExhibitionCreateInfoResponseDto.builder()
